...
```plain text
1.93% dos devs estão satisfeitos com Go.
2.70% usam assistentes de IA no desenvolvimento em Go, principalmente para autocomplete e geração de testes.
3.IA não é tão utilizada para documentação de código.
4.61% dos devs usam Linux durante o desenvolvimento.
5.96% deployam em ambientes Linux.
6.4% deployam para WebAssembly.
7.66% usam o VS Code, 35% usam GoLand e 33% usam dois ou mais editores.
8.A simplicidade do Go é altamente apreciada pelos devs.
9.O ciclo rápido de compilação e teste é um dos maiores atrativos do Go.
10.A consistência nos padrões de codificação é o maior desafio.
11.A robustez do tooling do Go é frequentemente destacada.
12.Os devs apreciam a sintaxe semelhante ao C que Go tem.
13.A garantia de compatibilidade com a versão 1.0 é algo muito bem visto.
14.O suporte dos cloud providers ao Go é um ponto forte.
15.Os devs acham fácil deployar Go na nuvem.
