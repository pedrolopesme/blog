...
export function homeMain(ctx, { posts }) {
  ...
  // Editorial masthead
  const masthead = `<section class="home-masthead">
    <span class="home-masthead__rule" aria-hidden="true"></span>
    <p class="home-masthead__tagline">${escapeHtml(ctx.site.tagline)}</p>
    <span class="home-masthead__flourish" aria-hidden="true">❧</span>
  </section>`;
