...
<head>
  <meta charset="utf-8" />
  <script>(function(){try{var d=document.documentElement,s=window.localStorage;var t=s.getItem("theme");if(!t){t=window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light";}d.dataset.theme=t;var sc=s.getItem("readScale");if(sc)d.style.setProperty("--reading-scale",sc);var mw=s.getItem("readMeasure");if(mw)d.style.setProperty("--measure",mw);}catch(e){}})();</script>
    ...
    <div class="wrap site-header__inner">
      ...
      <nav class="site-nav" id="site-nav" aria-label="Navegação principal">
        ...
        <div class="site-tools">
          <button type="button" class="tool tool--type" aria-label="Ajustar tipografia" title="Tipografia">Aa</button>
          <button type="button" class="tool tool--theme" aria-label="Alternar tema claro/escuro" title="Tema">
            <span class="tool__sun" aria-hidden="true">☀</span><span class="tool__moon" aria-hidden="true">☾</span>
          </button>
        </div>
      </nav>
    </div>
