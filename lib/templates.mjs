...
<head>
  <meta charset="utf-8" />
  <script>(function(){try{var d=document.documentElement,s=window.localStorage;d.dataset.theme=s.getItem("theme")||"light";var sc=s.getItem("readScale");if(sc)d.style.setProperty("--reading-scale",sc);var mw=s.getItem("readMeasure");if(mw)d.style.setProperty("--measure",mw);}catch(e){}})();</script>
