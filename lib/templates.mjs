...
export function articleMain(ctx, post, related = [], prev = null, next = null, quote = null) {
  ...
  const postNav = (prev || next)
    ...
    <script>(function(){var b=document.body,t=function(){if(window.scrollY>window.innerHeight*0.55){b.classList.add("nav-visible");}else{b.classList.remove("nav-visible");}};window.addEventListener("scroll",t,{passive:true});t();})();</script>`
    : "";
